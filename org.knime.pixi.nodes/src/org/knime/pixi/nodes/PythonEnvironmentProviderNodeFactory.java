        ...
        return DefaultNode.create().name("Python Environment Provider (Preview)") //
            ...
            .fullDescription( //
                """
                        ...
                        lock file specification. In the <code>Conda</code> preferences page, you can configure
                        where the environments should be created and cached.
                        By default, they are stored in temporary directories and automatically cleaned up,
                        but you can also choose to store them in a fixed location.
                        </p>""") //
            .sinceVersion(5, 11, 0)
