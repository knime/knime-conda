 ...
 */
public class CondaEnvironmentRegistry2 {

    private static final String EXT_POINT_ID = "org.knime.conda.envbundling.CondaEnvironment";

    private static final NodeLogger LOGGER = NodeLogger.getLogger(CondaEnvironmentRegistry2.class);
     ...
     */
    public static List<CondaEnvironmentExtension> collectExtensions() {
